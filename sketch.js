...
function setup() {
 ...
 laser1 = new laserShoot(600,500,40,140)
  
 muteBtn = createImg("pngaaa.com-4441837.png");
 muteBtn.position(1200,500);
 muteBtn.size(50,50)
...
function createLaser(){
  ...
  //laser1.display();
 laser_sound.play();
 Matter.Body.applyForce(laser1,laser1.position,{x:0,y:0},{x:0,y:1});
}
  ...
  swal(
    {
      ...
      imgUrl:
      "https://cdn2.steamgriddb.com/file/sgdb-cdn/logo/ef50c335cca9f340bde656363ebd02fd.png",
